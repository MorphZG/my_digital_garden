...
- **03_Literature_notes**
   ...
   - Remember that you can also include additional links to notes under the `01_Reference` directory if available. Would be good to review the content from time to time and create additional links if they become available at a later time.
